...
import 'setname_viewmodel.dart';

class SetnameView extends StackedView<SetnameViewModel> {
  const SetnameView({Key? key}) : super(key: key);

  @override
  Widget builder(
    BuildContext context,
    SetnameViewModel viewModel,
    Widget? child,
  ) {
    return Scaffold(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: CustomButton(
                              text: "Next",
                              onPressed: () {
                                viewModel.navigateToAccountCreated();
                              },
                            ),
                          ),
  ...
  @override
  SetnameViewModel viewModelBuilder(
    BuildContext context,
  ) =>
      SetnameViewModel();
}
